# Blender 4.5 Addon Build Script - Clone Tools Fork
# Following Blender addon packaging best practices
...
Write-Host "=== Blender 4.5 Addon Build Script ===" -ForegroundColor Cyan
